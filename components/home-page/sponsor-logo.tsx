              ...
              <div className="p-1">
                <Card>
                  <CardContent className="flex aspect-square items-center justify-center">
                    <a target="_blank" href="https://t.me/cryptokalliya">
                      <Image src="/images/sponsors/CK_White.png" alt="Crypto Kalliya"
                        width={100}
                        height={100}
                        />
                    </a>
            ...
            <CarouselItem key="1" className="md:basis-1/2 lg:basis-1/4">
              <div className="p-1">
                <Card>
                  <CardContent className="flex aspect-square items-center justify-center">
                    <a target="_blank" href="https://chainlyze.ai">
                        <Image src="/images/sponsors/Chainlyze_B.png" alt="Chainlyze"
                            width={100}
                            height={100}
                            />
                        </a>
            ...
            <CarouselItem key="2" className="md:basis-1/2 lg:basis-1/4">
              <div className="p-1">
                <Card>
                  <CardContent className="flex aspect-square items-center justify-center">
                    <a target="_blank" href="https://perfectustec.com">
                        <Image src="/images/sponsors/perfectus_horizontal_logo_green_white.png" alt="Perfectus Tec"
                        width={100}
                        height={100}
                        />
                    </a>
            ...
            <CarouselItem key="4" className="md:basis-1/2 lg:basis-1/4">
              <div className="p-1">
                <Card>
                  <CardContent className="flex aspect-square items-center justify-center">
                    <a target="_blank" href="https://technews.lk">
                        <Image src="/images/sponsors/techie-logo-technews.lk.png" alt="Technews.lk"
                        width={100}
                        height={100}
                        />
                    </a>
            ...
            <CarouselItem key="5" className="md:basis-1/2 lg:basis-1/4">
              <div className="p-1">
                <Card>
                  <CardContent className="flex aspect-square items-center justify-center">
                    <a target="_blank" href="https://ceylonnewsfactory.lk/">
                        <Image src="/images/sponsors/CNF logo.png" alt="Ceylon News Factory"
                        width={60}
                        height={60}
                        />
                    </a>
            ...
            <CarouselItem key="6" className="md:basis-1/2 lg:basis-1/4">
              <div className="p-1">
                <Card>
                  <CardContent className="flex aspect-square items-center justify-center">
                    <a target="_blank" href="https://nelnamango.com/">
                        <Image src="/images/sponsors/Nelna Mango.png"
                        alt="Nelna Agri Development"
                        width={80}
                        height={80}
                        />
